...
def _peek_config_arg(params, arg_name, default=None):
    """Read a --key=value CLI arg without mutating params."""
    for _v in params:
...
if __name__ == '__main__':
    ...
    # Peek before _get_config removes --config/--env-config from argv.
    alg_config_name = _peek_config_arg(params, "--config", "default")
    ...
    config_dict["config_name"] = alg_config_name
